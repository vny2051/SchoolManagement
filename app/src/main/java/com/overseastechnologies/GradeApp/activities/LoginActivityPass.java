...
public class LoginActivityPass extends AppCompatActivity {
    ...
    String apiUrl = "http://schoolmanagement.jihsuyaainfotech.in/api/student/";
...
//                    JsonRequest jsonRequest = new JsonRequest(Request.Method.POST, apiUrl, new Response.Listener<String>() {
//                        @Override
