package com.overseastechnologies.GradeApp.ui.Assignment;
...
import com.overseastechnologies.GradeApp.fragments.assignment.FragmentAssignments;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab_text_live_assignments}; //page nu title
